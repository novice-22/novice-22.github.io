...
export const CATEGORIES = [
  ...
  // 개인 연구·공부 기록 — 노션의 별도 DB("Research")에서 직접 읽어온다.
  // 분야가 늘면 아래 children 에 { slug, name } 한 줄만 추가하면 된다.
  {
    slug: "research",
    name: "Research",
    children: [{ slug: "mcp", name: "MCP" }],
  },
];
  ...
  resume: [
    ...
    //   패턴: { when: "대상 프로젝트", name: "CVE 번호(또는 발급 대기)", desc: "CWE 등 비고" }
    {
      ...
      items: [
        ...
        { when: "mcphub", name: "CVE-2026-79747", desc: "", href: "https://github.com/samanhappy/mcphub/security/advisories/GHSA-9wx9-prgc-gmjr" },
      ],
    },
    // 버그바운티 — 플랫폼별로 항목이 쌓임.
